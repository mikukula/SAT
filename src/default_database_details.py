...
class DefaultAnswers:
    def __init__(self):
        ...
        self.answer_text = ["SD,D,N,A,SA",
                            "SD,D,N,A,SA, N/D",
                            "§ Desktop / laptop PCs § Smartphones and tablets § Consumer grade smart devices § Enterprise IoT / IIoT devices § Cloud-based storage § Cloud-based applications / services § Operational Technology (OT) § Embedded technologies",
